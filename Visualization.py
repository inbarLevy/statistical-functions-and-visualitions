...
# visualization for query number 2: time complexity: O(n) n- number of rows
...
# visualization for query number 3: time complexity: O(n) n- number of rows
...
# visualization for query number 4: time complexity: O(n) n- number of rows
...
# visualization for query number 5: time complexity: O(n+m) n- number of rows m-number of columns
...
plt.xticks(temps)
plt.scatter(temps, rows, c=colors, s=70)
plt.show()

# visualization for query number 8: time complexity: O(n+m) n- number of rows m-number of columns
locations = ['0', '1', '2']
...
plt.bar(locations, temps, color='lightpink', edgecolor='darkred', linewidth=1, width=0.3)
plt.show()
